...
async def test_a_double_written_graph_migrates_itself_over_ws(db_name):
    """The ws:// copy of the embedded keep-verdict migration test.

    Same reason as the one above: both deployments reach `_setup_schema`, and
