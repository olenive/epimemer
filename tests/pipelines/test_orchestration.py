...
async def _prepare_store_payload(
    storage, embedding_provider, config, content="Test content about AI."
):
...
class TestOrchestrationRouting:
    async def test_segment_routes_correctly(self, storage, embedding_provider, config):
    ...
    async def test_store_decomposition_routes_correctly(self, storage, embedding_provider, config):
    ...
    async def test_search_routes_correctly(self, storage, embedding_provider, config):
    ...
    async def test_reflect_routes_correctly(self, storage, embedding_provider, config):
    ...
    async def test_tokens_flow_through_places(self, storage, embedding_provider, config):
        request = MemoryRequest(
            action="segment",
...
class TestAutoReflect:
    ...
    async def test_auto_reflect_triggers_after_n_stores(self, storage, embedding_provider, config):
    ...
    async def test_search_does_not_increment_counter(self, storage, embedding_provider, config):
