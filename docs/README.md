...
| [ATTRIBUTION.md](ATTRIBUTION.md) | Who judged this — the agent registry, why the user assigns the id, how approval reaches them, what a self-description is worth, and the append-only journal that answers *what did this agent judge* |
